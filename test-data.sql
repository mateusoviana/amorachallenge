...
INSERT INTO apartments (title, description, price, condominium_fee, iptu, address, neighborhood, city, state, bedrooms, bathrooms, parking_spaces, area, is_public, owner_id, images) VALUES
('Apartamento Moderno no Centro', 'Apartamento recém-reformado com acabamento de luxo', 450000, 500, 1200, 'Rua das Flores, 123', 'Centro', 'São Paulo', 'SP', 2, 2, 1, 75, false, (SELECT id FROM users WHERE email = 'joao@teste.com'), ARRAY['https://via.placeholder.com/300x200']),
('Cobertura Duplex', 'Cobertura com vista panorâmica da cidade', 1200000, 800, 3000, 'Av. Paulista, 1000', 'Bela Vista', 'São Paulo', 'SP', 3, 3, 2, 120, true, (SELECT id FROM users WHERE email = 'maria@teste.com'), ARRAY['https://via.placeholder.com/300x200']);
